...
public final class AdvancedRocketryTestConstants {
    ...
    public static String expectedWeatherMode() {
        ...
        // isolated weather through the B1 Mixin wrapper
        // (PlanetWeatherManager + MixinWorldServerMulti), so rain on the
        // overworld does not leak to AR dims. Override with
        // -Dadvancedrocketry.tests.expectedWeatherMode=shared when
        // verifying a regression back to vanilla weather behaviour.
