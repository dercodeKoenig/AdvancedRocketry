package zmaster587.advancedRocketry.repack.gloomyfolken.hooklib.helper;
...
public class DictionaryGenerator {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = FileUtils.readLines(new File("C:\\Users\\Quarter\\Documents\\AdvancedRocketry\\build\\extractMappings\\methods.csv"));
        lines.remove(0);
        ...
        DataOutputStream out = new DataOutputStream(new FileOutputStream("C:\\Users\\Quarter\\Documents\\methods.bin"));
